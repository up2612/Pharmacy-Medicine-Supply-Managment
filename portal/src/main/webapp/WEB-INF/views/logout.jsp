	...
	<div class="container">
		...
		<div class="col-lg-10 col-xl-7 mx-auto" style="margin-top: 100px;">
			<center>
				...
				<h4 class="display-7">Please Visit Again</h4>
			</center>
		</div>
...
<div 
	style="padding-left: 480px; position: fixed; bottom: 0;"><h4 class="display-12">Please Take Covid Vaccine At Your Turn</h4></div>
